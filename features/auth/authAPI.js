...
//     try {
//       const response = await fetch("http://192.168.1.3:8000/api/v1/users/login", {
//         method: "POST",
...
export function loginUser(loginInfo) {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch("http://192.168.1.8:8000/api/v1/users/login", {
        method: "POST",
        body: JSON.stringify(loginInfo),
        headers: { "content-type": "application/json" },
      });
...
export function checkUser() {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const response = await fetch("http://192.168.1.8:8000/api/v1/users/current-user", {
        method: "GET",
        headers: {
...
//       const response = await fetch("http://192.168.1.3:8000/api/v1/users/current-user", {
//         method: "GET",
//         headers: {
