...
export default function MyPage() {
  ...
  return (
    ...
    <Ionicons name="notifications-outline" size={24} color="black" /></View>
        ...
        <KeyboardAvoidingView className="mt-11 mb-11">
            <Text className="text-2xl font-bold">Quote Price</Text>
            <Formik
     initialValues={{ EnterPrice: '' }}
     onSubmit={(values) => {
   ...
   >
     {({ handleChange, handleBlur, handleSubmit, values }) => (
       <View className="mt-[30px]">
         <TextInput  style={{ borderBottomWidth: 2,borderBottomColor: 'black', borderStyle: 'solid',padding: 10,width: '100%',
        marginTop: 10}} placeholderTextColor="#000" 
        onChangeText={handleChange('EnterPrice')}
        onBlur={handleBlur('EnterPrice')}
        value={values.EnterPrice}
        keyboardType="numeric"
        placeholder='Enter Price'
        />
         <TouchableOpacity onPress={handleSubmit}>
         <View className="w-[100px] h-[40px] ml-[10px] mt-[30px] rounded-2xl  bg-blue-500 flex items-center justify-center">
