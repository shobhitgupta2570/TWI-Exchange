  ...
  return (
    ...
    <Ionicons name="notifications-outline" size={24} color="black" /></View>
      {/* {image && <Image source={{ uri: image }} style={styles.image} onPress={pickImage}/>} */}
        ...
        <View className="mt-11 ml-[200px] rounded-lg mb-6 h-[45px] w-[150px] flex items-center justify-center bg-blue-900">
            <Text className="text-xl font-medium text-white">Quote Price</Text>
          
        </View>

        <View className="mr-[200px] rounded-lg mb-6 h-[45px] w-[150px] flex items-center justify-center bg-blue-900">
            <Text className="text-xl font-medium text-white">Counter Price</Text> 
        </View>

        <View className=" ml-[200px] rounded-lg  h-[45px] w-[150px] flex items-center justify-center bg-blue-900">
            <Text className="text-xl font-medium text-white">Revised Price</Text>
          
        </View>
      
      <View className="bg-white h-[50px] w-[140px] rounded-2xl flex items-center justify-center mt-[110px]"><Text className="text-xl text-blue-700 font-semibold">Accept</Text></View>
        </View>
