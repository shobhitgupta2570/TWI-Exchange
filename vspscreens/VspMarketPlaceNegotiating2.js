...
export default function MyPage() {
  ...
  return (
    ...
    <Ionicons name="notifications-outline" size={24} color="black" /></View>
        ...
        <View className="mr-[200px] rounded-lg mb-11 h-[45px] w-[150px] flex items-center justify-center bg-blue-900">
            <Text className="text-2xl font-bold text-white">Counter Price</Text> 
        </View>
      
      <View className="bg-white h-[50px] w-[140px] rounded-2xl flex items-center justify-center mt-[120px]"><Text className="text-xl text-blue-700 font-semibold">Accept</Text></View>
        </View>
