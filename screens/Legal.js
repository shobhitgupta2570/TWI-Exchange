...
export default function MyPage() {
  ...
  return (
    ...
    <View style={styles.container}>
     <View>
      <Text style={{fontSize:25}}>Legal</Text>
      <Text style={{fontSize:10, paddingTop:30}}>Lorem ipsum kfmngnnnnnn ksakk rrtuaaaaaaaaaa eeeefdvkhgfjlnb sd,fnsuij.xj khfkcm,d djheuewljbsdhwefleshuioyaefkj kjjdkwnfm,sjdfiefkenfm</Text>
