    ...
    <TouchableWithoutFeedback onPress={() => setMenuVisible(false)}>
      ...
      {/* {image && <Image source={{ uri: image }} style={styles.image} onPress={pickImage}/>} */}
        ...
        <View className="w-[95%] bg-white h-[100px] mb-1">
            ...
            <View className="flex-column"><Text className="text-blue-300 text-lg font-bold pl-5">Quote Price: 123</Text>
            <Text className=" font-thin pl-3">4.5 | 1 hr 20 mins away| 30km</Text></View>
      ...
      >
        <View className="" style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
          ...
          <View  className="ml-[250px]"><AntDesign name="close" size={24} color="black" onPress={()=>{setModalVisible(false) ;navigation.navigate('tripStatus') }}  /></View>
            ...
            <Text className=" mt-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor .</Text>
                ...
                <TouchableOpacity ><View className=" h-[40px] bg-gray-200  w-[100px] ml-11 mt-5 rounded-2xl border-2 border-red-700"></View></TouchableOpacity>
            </View>
        </View>
        </View>
