  ...
  const handleSubmit = () => {
    ...
    <Ionicons name="notifications-outline" size={24} color="black" /></View>
      {/* {image && <Image source={{ uri: image }} style={styles.image} onPress={pickImage}/>} */}
        ...
        <View className="flex-row gap-5 bg-blue-400">
    ...
    borderRadius: 40,
            ...
            <View className="flex-column">
                <TouchableOpacity onPress={openModal}><View className=" h-[50px] bg-white w-[260px] ml-[20px] mt-1 rounded-2xl border-2 border-blue-700"></View></TouchableOpacity>
                {/* Modal */}
      <Modal
        animationType="slide"
        transparent={true}
